...
fun main(args: Array<String>) {
    ...
    val commands =
        mapOf(
            ...
            "2024day9p1" to InputToLongCommand { y2024day9part1(StdinInput()) },
            "2024day9p2" to LinesToLongCommand { y2024day9part2(StdinInput()) },
            "2024day10p1" to InputToLongCommand { y2024day10part1(StdinInput()) },
            "2024day10p2" to LinesToLongCommand { y2024day10part2(StdinInput()) },
            "2024day11p1" to InputToLongCommand { y2024day11part1(StdinInput()) },
            "2024day11p2" to LinesToLongCommand { y2024day11part2(StdinInput()) },
            "2024day12p1" to InputToLongCommand { y2024day12part1(StdinInput()) },
            ...
            "2024day15p1" to InputToLongCommand { y2024day15part1(StdinInput()) },
            "2024day15p2" to LinesToLongCommand { y2024day15part2(StdinInput()) },
            "2024day16p1" to InputToLongCommand { y2024day16part1(StdinInput()) },
            "2024day16p2" to LinesToLongCommand { y2024day16part2(StdinInput()) },
        )
